package net.lee.bettertips.util;
...
public class ModIdentity {
    ...
    private static boolean isMinecraftBlock(int id) {
        return (id >= 170 && id <= 174) || id <= 163;
    }

    private static boolean isMITEItem(int id) {
        if (id > 955 && id < 1283) {
            if (id < 1058 || id > 1066 || id < 1135 || id > 1141 || id < 1168 || id > 1171 || id < 1265 || id > 1275) {
                return true;
            }
    ...
    private static boolean isMinecraftItem(int id) {
        if (id > 256 && id <= 422) {
            if (id <= 269 || id >= 280 || id <= 309 || id >= 314 || id <= 408 || id >= 417) {
                return true;
            }
